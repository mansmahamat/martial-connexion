...
const MAPBOX_TOKEN = 'pk.eyJ1IjoibWFuc2Rlc21leiIsImEiOiJjbDF2NG55b2IwMDlxM2pwbGEwYnh1aDNlIn0.rBwxZ81BZ0mcpoI-jMqKgg';
...
console.log(events)
  ...
  return (
    ...
    */}
    ...
    >
       <Marker longitude={Number(data?.longitude)} latitude={Number(data?.latitude)} color="red" />
       </Map>
        </div>
                ...
                <div className="border-t border-gray-200 px-4 py-5 sm:px-6">
                  <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                    ...
                    <div className="sm:col-span-1">
                      ...
                      <dd className="mt-1 text-sm text-gray-900"> {data?.kids ? "Oui" : "Non"}</dd>
                    </div>
                    <div className="sm:col-span-1">
                    ...
                    <ul className="border border-gray-200 rounded-md divide-y divide-gray-200">
                        ...
                        <li key={index} className='text-gray-900 text-lg'> {price} </li>
                      ))}
                      </ul>

                      <ul className="border border-gray-200 rounded-md divide-y divide-gray-200">
                        {prices.map((price: any, index: any) => (
                        <li key={index} className='text-gray-900 text-lg'> {price.discipline} : {price.price} € </li>
                      ))}
                      </ul>
                          ...
                          <div className="flex space-x-3">
                            ...
                            <div>
                              ...
                              <div className="mt-1 text-sm text-gray-700">
                                <p>{data?.userId[0].email}</p>
                              </div>
                              <div className="mt-2 text-sm space-x-2">
                                <span className="text-gray-500 font-medium">Inscrit depuis le {data?.userId[0].date}</span>{' '}
