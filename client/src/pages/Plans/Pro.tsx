              ...
              <div className="px-2 space-y-1">
                {navigation.map((item) => (
                  <a
                    ...
                    href={item.href}
                    className={classNames(
                      item.current ? 'bg-cyan-800 text-white' : 'text-red-300 hover:text-white hover:bg-cyan-600',
                ...
                <div className="px-2 space-y-1">
                  {secondaryNavigation.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md text-red-300 hover:text-white hover:bg-cyan-600"
                    >
                      <item.icon className="mr-4 h-6 w-6 text-red-300" aria-hidden="true" />
                      {item.name}
                    </a>
                  ))}
                </div>
